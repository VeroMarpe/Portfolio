...
st.set_page_config(page_title="Servicios — Verónica", page_icon="🧩", layout="wide")
...
st.info("¿Necesitas algo específico? Puedo preparar una demo rápida con tus datos de ejemplo.")